...
export default function Shell({ page, setPage, label, children }) {
  return (
    <main className="min-h-screen bg-white p-0">
      <section className="grid-paper min-h-screen w-full p-4 sm:p-6 lg:p-8">
        <p className="mb-2 text-xs font-bold text-[#8f8f8f]">{label}</p>
        <div className="min-h-[calc(100vh-5rem)] rounded-md border border-smoke bg-white shadow-soft">
